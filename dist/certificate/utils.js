...
exports.log = exports.challengeRemoveFn = exports.challengeCreateFn = void 0;
 ...
 * @returns {Promise}
 */
function challengeCreateFn(challenge, keyAuthorization) {
 ...
 * @returns {Promise}
 */
function challengeRemoveFn(challenge) {
    return __awaiter(this, void 0, void 0, function* () {
        /* Do something here */
